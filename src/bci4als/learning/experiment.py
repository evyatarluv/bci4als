...
class Experiment:
    ...
    def __init__(self, num_trials, next_length, cue_length, ready_length, trial_length):
        ...
        self.images_path: Dict[str, str] = {'right': 'images/arrow_right.jpeg',
    ...
    def _init_labels(self):
        ...
        pd.DataFrame.from_dict(labels).to_csv(self.subject_directory + '\\stimulus_vectors.csv',
    ...
    def _user_messages(self, trial_index):
        ...
        # Show cue
        cue = visual.ImageStim(win, trial_image)
        cue.draw()
        win.flip()
